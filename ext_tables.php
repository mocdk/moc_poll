...
$TCA['tx_mocpoll_domain_model_poll'] = array(
	'ctrl' => array(
		...
		'dynamicConfigFile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('moc_poll') . 'Configuration/TCA/Poll.php', 'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('moc_poll') . 'Resources/Private/Icons/icon_tx_mocpoll_domain_model_poll.gif',),
);
...
$TCA['tx_mocpoll_domain_model_response'] = array(
	'ctrl' => array(
		...
		'dynamicConfigFile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('moc_poll') . 'Configuration/TCA/Response.php', 'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('moc_poll') . 'Resources/Private/Icons/icon_tx_mocpoll_domain_model_response.gif',),
);
